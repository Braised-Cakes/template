...
export default {
    data() {
        return {
            ...
            localPagination: Object.assign({}, this.pagination, {
                pageSizeOptions: ['10', '30', '60', '90', '120']
            })
        }
    },
    ...
    created() {
        ...
        const localPageNum = (this.supportURI && page && parseInt(page)) || this.pageNum
        const localPageSize = (this.supportURI && pageSize && parseInt(pageSize)) || this.pageSize
    ...
    methods: {
        ...
        loadData(pagination, filters, sorter) {
            ...
            // 对接自己的通用数据接口需要修改下方代码中的 r.info.page, r.info.total, r.results
            ...
            if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
                result.then(r => {
                    if (_.isArray(r)) {
                        ...
                        this.localPagination.pageSize = 9999
                    }
                    this.localPagination =
                        (this.showPagination &&
                            Object.assign({}, this.localPagination, {
                                current: r.info.page, // 返回结果中的当前分页数
                                total: r.info.total, // 返回结果中的总记录数
                                showSizeChanger: this.showSizeChanger,
                    ...
                    try {
                        if (
                            ['auto', true].includes(this.showPagination) &&
                            r.info.total <= r.info.page * this.localPagination.pageSize
                        ) {
                    ...
                    this.supportURI &&
                        this.$router.replace({
                            query: Object.assign({}, this.$route.query, this.supportURI)
                        })
                })
            }
        },
        initTotalList(columns) {
            ...
            columns &&
                ...
                columns.forEach(column => {
                    column.ellipsis = _.has(column, 'ellipsis') ? column.ellipsis : true
                    column.align = 'center'
                    if (column.needTotal) {
                        totalList.push({
                            ...column,
